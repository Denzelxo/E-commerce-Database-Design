...
This project involves designing and documenting a relational database schema for an e-commerce platform. The objective is to model key entities such as products, brands, variations, categories, sizes, and custom attributes in a scalable and normalized format.

## ✅ Work Done

### 1. **Schema Development**
We created a normalized SQL schema using MySQL with the following core tables:
...
| `product_variation` | Combines product, size, and color into unique variations |
...
🖼️ [View ERD Diagram](./A_Entity-Relationship_Diagram_(ERD)_for_an_e-comme.png)
...
📄 [`modified_ecommerce_schema.sql`](./modified_ecommerce_schema.sql)
...
6. **product_items** hold stock, pricing, and are what customers actually buy
...
This data model ensures that every product can be richly described, flexibly customized, and precisely tracked through variations and inventory.

---

## 🧠 Learning Outcomes
- Hands-on experience with SQL DDL
- Understanding of e-commerce data modeling
...
- **ChatGPT** – for schema guidance and documentation
